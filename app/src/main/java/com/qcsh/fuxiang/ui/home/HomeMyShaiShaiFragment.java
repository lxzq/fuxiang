 ...
 */
public class HomeMyShaiShaiFragment extends BaseFragment implements XListView.IXListViewListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        initData();
        adapter = new CommonAdapter<GrowthTreeEntity>(getActivity(), dataList, R.layout.activity_growthtreeitem) {
            @Override
            public void convert(final ViewHolder holder, final GrowthTreeEntity growthTreeEntity) {
                ...
                TextView contentText = holder.getView(R.id.item_content);
    ...
    private void initData() {
        ...
        showProgress();
        ApiClient.get(this.getActivity(), ApiConfig.HOME_MY_COLLECT, new ApiResponseHandler<GrowthTreeEntity>() {
            @Override
        ...
        }, "userId", getCurrentUser().getId(), "type", "2", "page", currentPage + "");
    }
