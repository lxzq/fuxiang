...
public class SwitchView extends View{
     ...
     * state switch on
     */
    public static final int STATE_SWITCH_ON = 4;//已经打开
    /**
     * state prepare to off
     */
    public static final int STATE_SWITCH_ON2 = 3;//准备关闭
    /**
     * state prepare to on
     */
    public static final int STATE_SWITCH_OFF2 = 2;//准备打开
    /**
     * state switch off
     */
    public static final int STATE_SWITCH_OFF = 1;//已经关闭
    /**
     * current state
     */
