package com.qcsh.fuxiang.widget.CityPicker_wheelView;
 ...
 */
public class MWheelView extends View{
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray attribute = context.obtainStyledAttributes(attrs,
                R.styleable.MWheelView);
        unitHeight = (int) attribute.getDimension(
                R.styleable.MWheelView_unitHight, 32);
        normalFont = attribute.getDimension(
                R.styleable.MWheelView_normalTextSize, 14.0f);
        selectedFont = attribute.getDimension(
                R.styleable.MWheelView_selectedTextSize, 22.0f);
        itemNumber = attribute.getInt(R.styleable.MWheelView_itemNumber, 7);
        normalColor = attribute.getColor(
                R.styleable.MWheelView_normalTextColor, 0xff000000);
        selectedColor = attribute.getColor(
                R.styleable.MWheelView_selectedTextColor, 0xffff0000);
        lineColor = attribute.getColor(R.styleable.MWheelView_lineColor,
                0xff000000);
        lineWidth = attribute.getDimension(R.styleable.MWheelView_lineHeight, 2f);
        maskHight = attribute.getDimension(R.styleable.MWheelView_maskHight,
                48.0f);
        noEmpty = attribute.getBoolean(R.styleable.MWheelView_noEmpty, true);
        isEnable = attribute
                .getBoolean(R.styleable.MWheelView_isEnable, true);
        attribute.recycle();
